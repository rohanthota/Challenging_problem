...
\end{lemma}
\begin{proof}
${X_i}$ is a sequence of i.i.d. random variables, which means it satisfies the following conditions.
\begin{align}
...
Let $Y_i=X_i^2$. We try to prove conditions \eqref{maincondA} and \eqref{maincondnB} for $Y_i$
\begin{enumerate} 
\item For $y \geq 0$,
\begin{align}
